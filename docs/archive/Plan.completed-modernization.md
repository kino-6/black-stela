# Archived: Black Stela Modernization Plan

This archive captures the completed modernization plan that produced the
current baseline. The active plan now lives at
[../../Plan.md](../../Plan.md).
