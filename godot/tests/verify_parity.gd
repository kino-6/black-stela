...
const PARITY_TRACES := ["b1f-turns", "b1f-wall", "b1f-exploration", "b1f-combat-victory", "b1f-combat-rounds", "b2f-ability", "b3f-poison", "b4f-caster", "verdant-wipe", "roster", "economy", "recovery", "recovery-blocked", "quests", "loot", "vocation", "b1f-trap", "b1f-shortcut", "b1f-stairs", "b1f-return", "b3f-disarm", "mastered-explorer", "b2f-chest", "combat-actions", "technique-families", "detonate", "expedition", "growth-items", "escape-resume", "camp-techniques", "legacy-combat", "verdant-expedition", "verdant-walk"]
