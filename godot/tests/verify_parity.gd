...
const PARITY_TRACES := ["b1f-turns", "b1f-wall", "b1f-exploration", "b1f-combat-victory", "b1f-combat-rounds", "b2f-ability", "b3f-poison", "b4f-caster", "verdant-wipe", "roster", "economy", "recovery", "recovery-blocked"]
