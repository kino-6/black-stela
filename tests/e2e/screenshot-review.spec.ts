...
test("captures authoring and B2F screenshot review states", async ({ page }) => {
  ...
  await page.getByTestId("scenario-pack-input").setInputFiles(defaultPackFiles(["manifest.md", "world.md", "items.md", "enemies.md", "encounters.md", "treasure.md", "progression.md", "quests.md", "dungeons/b1f.md", "dungeons/b2f.md", "dungeons/b3f.md", "dungeons/b4f.md", "dungeons/b5f.md", "dungeons/b6f.md", "dungeons/b7f.md", "dungeons/b8f.md"]));
