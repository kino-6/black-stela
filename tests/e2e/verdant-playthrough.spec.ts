...
test("play verdant: enter the sunken maze, fight a verdant foe, return to exploring", async ({ page }, testInfo) => {
  ...
  await page.screenshot({ path: testInfo.outputPath("verdant-combat.png") });
