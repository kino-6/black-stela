...
export const ja = {
  ...
  save: {
    ...
    save: "保存",
    load: "読込",
    browserTitle: "セーブを読み込む",
    menuTitle: "記録する",
    autosave: "自動セーブ",
    manualSlot: "セーブ {n}",
    emptyManual: "空き",
    noSaves: "セーブがありません — 新たな探索を始めよう。",
    saveHere: "ここに記録する",
    overwrite: "上書きする",
    savedToSlot: "{slot} に記録した。",
  ...
  party: {
    ...
    techniqueSummary: {
      ...
      targetParty: "味方全体",
      targetEnemy: "敵",
      targetAllEnemies: "敵全体",
      magSmall: "小",
      magMedium: "中",
      magLarge: "大",
      attack: "{target}に{mag}ダメージ",
      heal: "{target}のHPを{mag}回復",
  ...
  play: {
    ...
    chestTrapOpenedAiled: "{trap}が作動——隊列に {damage} の傷と{ailment}。宝箱は開いた。",
    trapNeedle: "毒針の罠",
    trapGas: "毒煙の罠",
    trapRune: "呪印の罠",
    trapSnare: "蔓縛りの罠",
  ...
  tempo: {
    ...
    auto: "オート",
    autoAttack: "攻撃オート",
    autoAttackHint: "自動ループ・攻撃重視——危険で停止（設定）",
    autoDefense: "守備オート",
    autoDefenseHint: "自動ループ——ward・状態治療・回復を優先、危険でも押し通す",
    repeatRound: "リピート",
  ...
  events: {
    ...
    chestTrapSprungAiled: "{trap}が作動！隊列に {damage} の傷と{ailment}。戦利品は無事だ。",
    chestOpened: "宝箱を開けた。",
