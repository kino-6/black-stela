export const en = {
  ...
  play: {
    ...
    firearmPistolDraw: "Quick Shot",
    firearmPistolAimed: "Aimed Shot",
    firearmPistolSuppress: "Suppressive Sight",
    firearmPistolPin: "Pinning Shot",
    firearmPistolRelay: "Relay Shot",
    firearmPistolMark: "Mark Share",
    firearmPistolBureau: "Bureau Shot",
    firearmPistolSeal: "Seal Warning",
    firearmPistolTerminal: "Terminal Sight",
    firearmPistolLastword: "Last Word",
    firearmRifleRest: "Rested Aim",
    firearmRifleSight: "Sighted Shot",
    firearmRifleBrace: "Stock Brace",
    firearmRifleHamper: "Hampering Shot",
    firearmRifleCutline: "Cut Line",
    firearmRifleScan: "Observation Shot",
    firearmRifleQuarantine: "Quarantine Shot",
    firearmRifleColdshot: "Cold Shot",
    firearmRifleEvac: "Evacuation Cover",
    firearmRifleLongwatch: "Long Watch",
    firearmSmgSweep: "Corridor Sweep",
    firearmSmgPush: "Pressing Shot",
    firearmSmgTurnstile: "Turnstile Sweep",
    firearmSmgScatter: "Scatter Denial",
    firearmSmgRainline: "Rainline Sweep",
    firearmSmgCrossfire: "Crossfire",
    firearmSmgBureau: "Bureau Sweep",
    firearmSmgLockdown: "Lockdown",
    firearmSmgZero: "Zero Sweep",
    firearmSmgBreakthrough: "Breakthrough",
    firearmShotgunBreach: "Breach Shot",
    firearmShotgunClose: "Close Shot",
    firearmShotgunPump: "Pump Stance",
    firearmShotgunStagger: "Stagger Shot",
    firearmShotgunSluice: "Sluice Breaker",
    firearmShotgunBrace: "Recoil Brace",
    firearmShotgunFloodgate: "Floodgate Shot",
    firearmShotgunGate: "Gate Shot",
    firearmShotgunTerminus: "Terminus Breaker",
    firearmShotgunFinal: "Final Spread",
    firearmPassiveQuickDraw: "Quick Draw",
    firearmPassiveSidearmDiscipline: "Sidearm Discipline",
    firearmPassiveSteadySight: "Steady Sight",
    firearmPassiveCloseControl: "Close Control",
    firearmPassiveBreachBrace: "Breach Brace",
    firearmPassiveLastPlatformStance: "Last Platform Stance",
    mpShort: "MP",
