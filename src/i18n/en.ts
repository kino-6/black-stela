export const en = {
  ...
  party: {
    ...
    studioCopy: "Register one adventurer at a time, then inspect the roster before the stair.",
    ...
    guildBriefing: "Register one adventurer at a time. Pick a calling, mark a face and past, spend the bonus points, then give the name that will go into the ledger.",
    ...
    chooseAppearance: "Choose face and past",
    allocateBonus: "Allocate bonus points",
    bonusRemaining: "{remaining}/{pool} points remaining",
    rerollBonus: "Reroll bonus",
    nameAdventurer: "Name the adventurer",
    next: "Next",
    back: "Back",
