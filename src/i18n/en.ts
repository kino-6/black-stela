export const en = {
  ...
  partyMenu: {
    ...
    equipmentTown: "Choose Items to equip carried gear.",
    equipmentDungeon: "Equipment can be reviewed here and changed after returning to town.",
    equipmentDungeonShort: "Change in town",
