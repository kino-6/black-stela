...
export const catalogIconUrls: Record<string, string> = {
  ...
  "equip.steel-sabre": equipMilitiaSabreUrl,
  "equip.war-spear": equipMilitiaSabreUrl,
  "equip.hunting-bow": equipRustedDirkUrl,
  "equip.rune-staff": equipAshwoodStaffUrl,
  "equip.scale-mail": equipRingMailUrl,
  "equip.war-helm": equipIronCapUrl,
  "equip.steel-gauntlets": equipGripGlovesUrl,
  "equip.tower-shield": equipSplitBucklerUrl,
  "equip.vitality-charm": equipBlackThreadRingUrl,
  "equip.focus-band": equipChalkCordUrl,
  "equip.antivenom-ring": equipBlackThreadRingUrl,
  "equip.dreamward-amulet": equipChalkCordUrl,
  "equip.swift-anklet": equipBlackThreadRingUrl,
  "equip.knight-plate": equipPaddedJackUrl,
