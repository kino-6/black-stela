---
id: dungeon.verdant.g9f
name: G9F - The Green Heart
level: 9
recommendedPartyLevel: 8
tags:
  - miniboss
  - shortcut
startRoom: room.verdant.g9f.001
map: |
  ###################
  #E#.#.............#
  #.#.#.##.#.####.###
  ...
  ###################
symbols:
  1: room.verdant.g9f.nook1
  2: room.verdant.g9f.nook2
  E: room.verdant.g9f.001
  X: room.verdant.g9f.exit
  M: room.verdant.g9f.keep
  A: room.verdant.g9f.02
  B: room.verdant.g9f.03
  C: room.verdant.g9f.04
  s: room.verdant.g9f.gate
  S: room.verdant.g9f.lift
corridor:
  name: Overgrown Path
...
edges:
  - from: room.verdant.g9f.001
    direction: west
    kind: stairs
    to: room.verdant.g8f.exit
    targetFloorId: dungeon.verdant.g8f
  - from: room.verdant.g9f.exit
    direction: west
    kind: stairs
    to: room.verdant.g10f.001
    targetFloorId: dungeon.verdant.g10f
  - from: room.verdant.g9f.gate
    direction: north
    kind: secret
    to: room.verdant.g9f.lift
  - from: room.verdant.g9f.02
    direction: west
    kind: door
  - from: room.verdant.g9f.c6_6
    direction: east
    kind: door
  - from: room.verdant.g9f.03
    direction: west
    kind: door
  - from: room.verdant.g9f.03
    direction: north
    kind: door
  - from: room.verdant.g9f.c10_14
    direction: south
    kind: door
  - from: room.verdant.g9f.04
    direction: west
    kind: door
  - from: room.verdant.g9f.c14_6
    direction: east
    kind: door
  - from: room.verdant.g9f.c13_6
    direction: south
    kind: door
  - from: room.verdant.g9f.keep
    direction: west
    kind: door
rooms:
  - id: room.verdant.g9f.001
    name: Root Landing
  ...
  - id: room.verdant.g9f.04
    ...
    locales:
      ja:
        name: 翠の間 3
        description: 樹冠の光が水面に翠色を落とす間。
  - id: room.verdant.g9f.keep
    name: Rootheart
    description: A close, root-walled keep; the only way deeper passes through it.
    encounterTable: encounters.verdant.g9.keep
    chest:
      treasureTable: treasure.verdant.g9.keep
      trap:
        kind: snare
        difficulty: 22
        damage: 13
