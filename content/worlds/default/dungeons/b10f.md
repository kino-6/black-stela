...
level: 10
role: finale
recommendedPartyLevel: 11
# IMP-064: the finale is colder and tighter than B5, but the black stela must emerge from readable stone,
# not from a featureless void. These values are deliberately subdued; they only protect local depth cues.
palette:
  ambient: "#34313a"
  ambientEnergy: 0.84
  fog: "#11141c"
...
rooms:
  - id: room.b10f.001
    ...
    event: Cold ash-light pools on the landing; someone in the party marks the way down into The Inmost Stela.
    restPoint: true
    locales:
      ja:
        name: 灰の踊り場
