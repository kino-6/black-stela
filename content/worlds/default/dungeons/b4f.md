...
tags:
  ...
  - block-2
authorNotes: >-
  Maze floor (棒倒し法 base + carved chambers, seed 40404, fullSweep ~334), reusing
  B4F's rooms and gimmicks. The spinner entry still turns the party's facing; the
  lantern halls (玄室, lantern-wards) sit as chambers off the winding galleries, and
  the One-Way Walk is a trap niche that slopes you back to the entry. The unlit square
  is the dark-zone down-stair, its chain seized until the winch in the lower lantern
  hall is wound. Secret unlit cache behind a searched wall. Stairs west up to B3F /
  west down to B5F. Generated by scripts/genFloorMaze.mjs.
