...
rooms:
  ...
  - { id: room.tl8f.dispatch-chamber, name: Dispatch Chamber, description: A deep control chamber keeps the final route alive., locales: { ja: { name: 指令室, description: 深い管制室が、最後の経路だけを生かしている。 } }, encounterTable: encounters.tl8f.control, chamberGuardian: true }
